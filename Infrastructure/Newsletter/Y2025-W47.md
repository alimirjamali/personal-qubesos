...
* **artwork** [v4.3.9-1](https://github.com/QubesOS/updates-status/issues/6200) (r4.3)
    ...
    - Previously PNG icons had to be re-generated via [Inkspace script](https://github.com/QubesOS/qubes-artwork/blob/main/icons/Makefile.common#L71-L75) every time SVG icons were updated. And they were installed as a part of default Qubes XDG icon set. As far as I understand, DE and GUI toolkits (XFCE, GTK) might require to dynamically render SVGs on the fly now (for App Menu, Qui widgets and some other places). The performance penalty should be negligible these days.
